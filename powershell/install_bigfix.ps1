...
if (Get-Service -Name BESClient -ErrorAction SilentlyContinue)
{
    ...
    # Lines with errors in ALL bigfix client logs:  (Get-Content ("C:\Program Files (x86)\BigFix Enterprise\BES Client\__BESData\__Global\Logs\*.log") -ErrorAction SilentlyContinue) -like "*error*"
    Exit 1
}
