...
"""
This is adapted from: https://github.com/PUNCH-Cyber/stoq-plugins-public/blob/master/peinfo/peinfo/peinfo.py
...
class PEInfo:
    def scan(self, file_path) -> Any:
        pe = self._get_pe_file(file_path)
    ...
    def _get_pe_file(self, payload):
        return pefile.PE(payload)
...
if __name__ == "__main__":
    PeFileInfo = PEInfo()
    print(PeFileInfo.scan(r"C:\Windows\explorer.exe"))
