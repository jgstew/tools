...
REM   Related: https://raw.githubusercontent.com/jgstew/tools/refs/heads/master/bash/install_bigfix.sh
REM            https://raw.githubusercontent.com/jgstew/tools/refs/heads/master/powershell/install_bigfix.ps1
